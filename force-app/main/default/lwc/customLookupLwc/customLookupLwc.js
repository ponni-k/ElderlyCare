...
import fetchLookupData from '@salesforce/apex/ElderlyCareReusableLookupController.fetchLookupData';
import fetchDefaultRecord from '@salesforce/apex/ElderlyCareReusableLookupController.fetchDefaultRecord';
...
handelSelectedRecord(event){   
     ...
     console.log('selectedRecord ***__>'+JSON.stringify(this.selectedRecord))
